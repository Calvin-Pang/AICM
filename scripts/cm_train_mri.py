...
from cm.MRI_datasets import load_data
...
def main():
    ...
    print('dir',args.weight_schedule)
    ...
    logger.log(f"Downsample method: {args.ds}, crop size: {args.crop}, scale: {args.scale}")
    data = load_data(
        root_path = '/raid/kaifengpang/datasets/IDX_cases_train_test/train',
